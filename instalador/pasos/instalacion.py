...
from instalador.clases.common import UserMessage, ProcessGenerator, \
...
from instalador.clases.particiones import Particiones
from instalador.config import INSTALL_SLIDES, BAR_ICON, SHAREDIR
import Queue
import gobject
import gtk
import os
...
import threading
import webkit
from instalador.clases import keyboard, i18n
from instalador.clases.i18n import install_language_pack
...
def install_process(CFG, q_button_a, q_button_b, q_view, q_label, q_win):
    ...
    uninstpkgs = [
        'instalador', 'live-config', 'live-boot',
    ...
    instpkgs_cpp = [[
        LIVE_PATH + '/pool/main/c/primeros-pasos/',
        'primeros-pasos'
        ]]
    debconflist = [
