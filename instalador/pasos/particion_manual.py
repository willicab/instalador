...
from instalador.clases import particion_nueva, \
    particion_redimensionar, particion_eliminar, particion_editar
from instalador.clases.common import floatify, humanize, TblCol, \
    is_primary, is_usable, PStatus, is_resizable, is_free, debug_list, is_logic
from instalador.clases.tabla_particiones import TablaParticiones
