...
from instalador.clases.common import TblCol, get_row_index, PStatus, \
    validate_maximun_fs_size, validate_minimun_fs_size, UserMessage, humanize
from instalador.clases.frame_fs import frame_fs, MSG_ENTER_MANUAL, \
    MSG_NONE
from instalador.config import FSMIN, FSMAX
from instalador.translator import msj, gettext_install
import gtk
