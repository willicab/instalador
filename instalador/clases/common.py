...
from instalador.config import APP_NAME, APP_COPYRIGHT, \
...
def ProcessGenerator(command):
    filename = '/tmp/instalador-' + random_generator()
...
#    print package_path('primeros-pasos')
#    print is_package_in_pool('primeros-pasos')
#==============================================================================
