...
from canaimainstalador.clases.common import UserMessage, ProcessGenerator, \
    ...
    crear_etc_network_interfaces, assisted_mount, assisted_umount, preseed_debconf_values
