...
class BarraTodo(gtk.DrawingArea):
    ...
    def expose(self, widget = None, event = None):
        ...
        self.ini = self.p.ini
        self.fin = self.p.fin
        self.tam = self.fin - self.ini
        self.total = self.tam
        self.swap = givemeswap()
        self.p.render = []
        factor = self.total / ESPACIO_TOTAL
        ...
        if self.forma == 'ROOT:SWAP':
            ini_1 = 0
            fin_1 = self.total - self.swap
            ini_2 = fin_1
            fin_2 = self.total
            ...
            self.particiones = [p_1,p_2]

        elif self.forma == 'ROOT:HOME:SWAP':
            ini_1 = 0
            fin_1 = ESPACIO_ROOT * factor
            ini_2 = fin_1
            ...
            self.particiones = [p_1,p_2,p_3]

        elif self.forma == 'BOOT:ROOT:HOME:SWAP':
            ini_1 = 0
            fin_1 = ESPACIO_BOOT * factor
            ini_2 = fin_1
            fin_2 = fin_1 + ESPACIO_ROOT * factor
            ini_3 = fin_2
            ...
            self.particiones = [p_1,p_2,p_3,p_4]

        elif self.forma == 'BOOT:ROOT:VAR:USR:HOME:SWAP':
            ini_1 = 0
            fin_1 = ESPACIO_BOOT * factor
            ini_2 = fin_1
            fin_2 = fin_1 + ESPACIO_ROOT * factor
            ini_3 = fin_2
            fin_3 = fin_2 + ESPACIO_VAR * factor
            ini_4 = fin_3
            fin_4 = fin_3 + ESPACIO_USR * factor
            ini_5 = fin_4
            fin_5 = self.total - self.swap
            ini_6 = fin_5
            fin_6 = self.total
            p_1 = ['', ini_1, fin_1, 0, 'ext4', 'primary', '', 0, 0, 0, 1]
            p_2 = ['', ini_2, fin_2, 0, 'ext4', 'primary', '', 0, 0, 0, 1]
            ...
            self.particiones = [p_1,p_2,p_3,p_4,p_5,p_6]

        elif self.forma == 'MANUAL':
            p_1 = ['', 0, self.total, 0, 'free', 'primary', '', 0, 0, 0, 1]
            self.p.render.append(self.forma+':'+str(self.total))
            self.particiones = [p_1,]
